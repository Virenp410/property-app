...
export default function DealerDashboardPage() {
  ...
  return (
    <div className="min-h-screen p-6 [@media(max-width:768px)]:p-4 [background:radial-gradient(980px_420px_at_-10%_-20%,rgba(201,162,77,0.24),transparent_64%),radial-gradient(820px_340px_at_110%_-18%,rgba(180,137,47,0.18),transparent_66%),linear-gradient(180deg,#f4ebd6_0%,#eadfbe_100%)]">
      <div className="mx-auto w-full max-w-[1180px]">
        <div className="rounded-[20px] border border-[#C9A24D] bg-[linear-gradient(135deg,#7a5319_0%,#a77723_58%,#c9a24d_100%)] p-3.5 shadow-[0_20px_40px_rgba(73,52,17,0.30)] [@media(max-width:768px)]:rounded-[16px] [@media(max-width:768px)]:p-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <span className="inline-flex min-h-10 items-center gap-2 rounded-full border border-[rgba(255,255,255,0.3)] bg-[rgba(255,255,255,0.14)] px-4 text-sm font-semibold text-[var(--color-white)]">
              <span className="h-2.5 w-2.5 rounded-full bg-[#f3d78a] shadow-[0_0_0_5px_rgba(201,162,77,0.24)]" />
              Mode: Dealer
            </span>
            <button
              type="button"
              className="inline-flex min-h-10 items-center justify-center rounded-xl border border-[#e3d0a4] bg-[linear-gradient(180deg,#ffffff_0%,#fbf3e0_100%)] px-4 text-sm font-semibold text-[#7b5b1a] transition-[transform,background-color,border-color,box-shadow] duration-200 ease-in-out hover:translate-y-[-1px] hover:border-[#d6c08e] hover:bg-[#f7eed6] hover:shadow-[0_10px_18px_rgba(73,52,17,0.22)]"
        ...
        <div className="mt-5 overflow-hidden rounded-[24px] border border-[#e3d1ab] bg-[linear-gradient(180deg,rgba(255,255,255,0.96)_0%,rgba(251,246,234,0.96)_100%)] shadow-[0_26px_50px_rgba(73,52,17,0.18)] [@media(max-width:768px)]:rounded-[18px]">
          <div className="grid min-h-[520px] place-items-center px-6 py-10 [@media(max-width:768px)]:min-h-[340px] [@media(max-width:768px)]:px-4">
            <div className="inline-flex flex-col items-center rounded-[22px] border border-[#ead9b6] bg-[linear-gradient(180deg,#ffffff_0%,#fbf6ea_100%)] px-8 py-6 text-center shadow-[0_14px_30px_rgba(73,52,17,0.10)] [@media(max-width:768px)]:px-6 [@media(max-width:768px)]:py-5">
              <span className="mb-3 block h-[3px] w-16 rounded-full bg-[linear-gradient(90deg,#c9a24d_0%,#f3d78a_100%)]" />
              <p className="m-0 text-[21px] font-semibold tracking-[0.01em] text-[#7b5b1a] [@media(max-width:768px)]:text-[17px]">
